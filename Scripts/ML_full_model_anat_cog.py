...
CHAPTER_ID = 'sklearn_matched_ABCD'
...
def save_png(fig_id, tight_layout=True, fig_extension='png', resolution=300):
    ...
    plt.savefig(path, format=fig_extension, dpi=resolution)
# Set directory
os.chdir("/Users/madeleineseitz/Desktop/sklearn_matched_ABCD")
# %%
# Import data....
def data():
    print("Loading data...", end="")
    X_train = pd.read_csv('/Users/madeleineseitz/Desktop/thesis/ABCD_Project/csvs/ML/X_train_cog_anat.csv')
    ...
    X_test = pd.read_csv('/Users/madeleineseitz/Desktop/thesis/ABCD_Project/csvs/ML/X_test_cog_anat.csv')
...
'tfmri_nback_all_223', 'tfmri_nback_all_232', 'tfmri_nback_all_262', 'tfmri_rec_all_beh_posf_dpr', 'tfmri_rec_all_beh_negface_pr', 
'tfmri_rec_all_beh_negf_dp', 'smri_thick_cdk_cuneuslh', 'smri_thick_cdk_rracatelh', 'smri_thick_cdk_rrmdfrlh', 'smri_thick_cdk_sufrlh', 
'smri_thick_cdk_supllh', 'smri_thick_cdk_trvtmlh', 'smri_thick_cdk_parsopcrh', 'smri_thick_cdk_sufrrh', 'smri_vol_cdk_trvtmlh', 
'smri_vol_cdk_iftmrh', 'sit_scr_values_count3', 'lmt_scr_num_timed_out', 'tfmri_mid_all_beh_hrwnfb_nt', 'tfmri_mid_all_beh_hlnfb_nt', 
'tfmri_sst_all_beh_crgo_stdrt', 'tfmri_sacgvf_bscs_pulh', 'tfmri_ma_lvnfb_b_cds_clatcgelh', 'tfmri_sst_nbeh_nruns', 'tfmri_sst_all_beh_crgo_nt',
'tfmri_sst_all_beh_incrlg_rt', 'tfmri_sacgvf_bscs_purh', 'tfmri_sacsvcg_bscs_crbcxlh', 'tfmri_saasvcg_bscs_tplh', 'tfmri_saasvcg_bscs_aalh', 
'tfmri_sacsvis_bscs_aarh', 'tfmri_nback_all_148', 'tfmri_nback_all_154', 'tfmri_nback_all_185', 'tfmri_nback_all_216', 'tfmri_nback_all_224', 
'tfmri_nback_all_237', 'tfmri_rec_all_beh_newnf_hr', 'smri_thick_cdk_fusiformlh', 'smri_thick_cdk_iftmlh', 'smri_thick_cdk_parsobislh',
'smri_thick_cdk_pclh', 'smri_thick_cdk_smlh', 'smri_thick_cdk_frpolelh', 'smri_thick_cdk_banksstsrh', 'smri_thick_cdk_ifplrh',
'smri_thick_cdk_insularh', 'smri_vol_cdk_rrmdfrrh', 'sit_scr_expr_mratdiff1'])]} # SFFS_RF
