...
CHAPTER_ID = 'sklearn_uniform_all_features_ABCD'
...
def save_png(fig_id, tight_layout=True, fig_extension='png', resolution=300):
    ...
    plt.savefig(path, format=fig_extension, dpi=resolution)
# Set directory
os.chdir("/Users/madeleineseitz/Desktop/sklearn_uniform_all_features_ABCD")
# %%
# Import data....
def data():
    print("Loading data...", end="")
    X_train = pd.read_csv('/Users/madeleineseitz/Desktop/thesis/ABCD_Project/csvs/ML/All_Data_Uniform_Model/X_train_uniform_all_features_reduced.csv')
    X_train = X_train.drop(columns= ['Unnamed: 0'])
    X_train = X_train.to_numpy()
    y_train = pd.read_csv("//Users/madeleineseitz/Desktop/thesis/ABCD_Project/csvs/ML/All_Data_Uniform_Model/y_train_all_data.csv")
    y_train = y_train['group'].to_numpy()
    X_test = pd.read_csv('/Users/madeleineseitz/Desktop/thesis/ABCD_Project/csvs/ML/All_Data_Uniform_Model/X_test_uniform_all_features_reduced.csv')
    X_test = X_test.drop(columns= ['Unnamed: 0'])
    X_test = X_test.to_numpy()
    y_test = pd.read_csv("/Users/madeleineseitz/Desktop/thesis/ABCD_Project/csvs/ML/All_Data_Uniform_Model/y_test_all_data.csv")
...
# %%
names = pd.read_csv('/Users/madeleineseitz/Desktop/thesis/ABCD_Project/csvs/ML/All_Data_Uniform_Model/X_train_uniform_all_features_reduced.csv')
...
feature_grid = {'feature_eng': [None,
                              ...
                              SelectColumns(['tfmri_mid_all_beh_hrwnfb_nt', 'tfmri_ma_alvcr_b_scs_tplh', 'tfmri_ma_acmvn_b_scs_aylh', 'tfmri_ma_acgml_b_scs_tplh',
...
'tfmri_mid_all_beh_lrwpfb_nt', 'tfmri_mid_all_beh_hlpfb_nt', 'tfmri_ma_acmvn_b_scs_tprh', 'tfmri_sacsvcg_bscs_crbwmrh', 'tfmri_nback_all_155',
 'smri_thick_cdk_paracnlh', 'sit_scr_expr_minitialrat', 'motor_5'])]} #SFFS/SFBS
