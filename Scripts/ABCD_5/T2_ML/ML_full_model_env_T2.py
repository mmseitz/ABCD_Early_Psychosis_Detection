...
CHAPTER_ID = 'sklearn_uniform_env_only_ABCD5'
...
def save_png(fig_id, tight_layout=True, fig_extension='png', resolution=300):
    ...
    plt.savefig(path, format=fig_extension, dpi=resolution)
# Set directory
os.chdir("/Users/madeleineseitz/Desktop/sklearn_uniform_env_only_ABCD5")
# %%
# Import data....
def data():
    ...
    X_test = pd.read_csv('/Users/madeleineseitz/Desktop/ABCD_5/T2_abcd5_env/X_test_uniform_env_reduced_abcd5_T2.csv')
    X_test = X_test.drop(columns= ['Unnamed: 0'])
    X_test = X_test.to_numpy()
    y_test = pd.read_csv("/Users/madeleineseitz/Desktop/ABCD_5/T2_abcd5_env/y_test_env_data_abcd5_T2.csv")
...
# %%
names = pd.read_csv('/Users/madeleineseitz/Desktop/ABCD_5/T2_abcd5_env/X_train_uniform_env_reduced_abcd5_T2.csv')
