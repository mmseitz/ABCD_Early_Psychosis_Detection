...
# %%
#note shape
abcd.shape #shape (1180, 45) HR n = 566
# %%
...
# %%
np.save("/Users/madeleineseitz/Desktop/X_train_env_data_abcd5_T2.npy", X_train)
np.save("/Users/madeleineseitz/Desktop/y_train_env_data_abcd5_T2.npy", y_train)
X_train = pd.DataFrame(X_train)
#X_train.columns = cols
X_train.to_csv('/Users/madeleineseitz/Desktop/X_train_env_data_abcd5_T2.csv', index=None, header=True)
y_train.to_csv('/Users/madeleineseitz/Desktop/y_train_env_data_abcd5_T2.csv', index=None, header=True)
#y_test = pd.Series(X_test.group)
y_test =  X_test[['group']]
y_test.to_csv('/Users/madeleineseitz/Desktop/y_test_env_data_abcd5_T2.csv', index=None, header=True)
y_test = y_test.to_numpy()
X_test = prepared_data[1].drop(['group'], axis=1)
np.save("/Users/madeleineseitz/Desktop/X_test_env_data_abcd5_T2.npy", X_test)
np.save("/Users/madeleineseitz/Desktop/y_test_env_data_abcd5_T2.npy", y_test)
X_test = pd.DataFrame(X_test)
#X_test.columns = cols
X_test.to_csv('/Users/madeleineseitz/Desktop/X_test_env_data_abcd5_T2.csv', index=None, header=True)
# %%
