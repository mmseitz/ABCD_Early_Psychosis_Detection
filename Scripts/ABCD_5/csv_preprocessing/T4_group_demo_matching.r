...
# Example data
#set.seed(123)
groupHR <- read_csv('/Users/madeleineseitz/Desktop/ABCD_5/R_matchIt/pps_T4_HR_demos.csv')

groupLR <- read_csv('/Users/madeleineseitz/Desktop/ABCD_5/R_matchIt/pps_T4_LR_demos.csv')
...
write.csv(matched_data, "/Users/madeleineseitz/Desktop/T4_demos_matched.csv")
write.csv(matched_groupLR, "/Users/madeleineseitz/Desktop/T4_LR_matched.csv")