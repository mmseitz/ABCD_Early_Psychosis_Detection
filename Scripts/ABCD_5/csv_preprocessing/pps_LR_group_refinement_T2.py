...
pps = pd.read_csv('/Users/madeleineseitz/Desktop/ABCD_5/PQBC_prepped/PQBC_T2_thresh4_ABCD_5.csv')
#PPS scores (raw)
...
matched_sample = pd.read_csv('/Users/madeleineseitz/Desktop/ABCD_5/R_matchIt/T2_demos_matched.csv')
#Matched LR group
matched_LR = pd.read_csv('/Users/madeleineseitz/Desktop/ABCD_5/R_matchIt/T2_LR_matched.csv')
# %%
####
...
no_PQBC = pps_LR_t2.loc[lambda pps_LR_t2: pps_LR_t2['PQBC_total_endorsed'] == 0] #LR group is 6210 pts
# %%
####
...
no_risk_hx = risk_hx.loc[lambda risk_hx: risk_hx['first_deg_fam_totals'] == 0] #df shape (3264, 101)
...
pps_refined.to_csv('/Users/madeleineseitz/Desktop/pps_refined_LR_T2.csv')
# %%
####
...
pps_age = abcd_log.loc[abcd_log['eventname'] == '2_year_follow_up_y_arm_1']
...
dems_dict['sex_chi'] = chi2_contingency(contingency_table1) # p = 0.0456
contingency_table2 = pd.crosstab(demos_r_grouped['group'], demos_r_grouped['income'])
dems_dict['income_chi'] = chi2_contingency(contingency_table2) # p = 1.1459E-76
contingency_table3 = pd.crosstab(demos_r_grouped['group'], demos_r_grouped['p_edu'])
dems_dict['p_edu_chi'] = chi2_contingency(contingency_table3) # p = 9.0865E-30
contingency_table4 = pd.crosstab(demos_r_grouped['group'], demos_r_grouped['race'])
dems_dict['ethnicity_chi'] = chi2_contingency(contingency_table4) # p = 2.6329E-55
dems_dict['age'] = stats.ttest_ind(demos_r_HR['interview_age'], demos_r_LR['interview_age'], equal_var= False) # p = 0.0002
print(dems_dict)
demos_r_LR.describe()
...
demos_r_HR.to_csv('/Users/madeleineseitz/Desktop/pps_T2_HR_demos.csv')
demos_r_LR.to_csv('/Users/madeleineseitz/Desktop/pps_T2_LR_demos.csv')
# %%
####
...
matched_short.to_csv('/Users/madeleineseitz/Desktop/T2_matched_demos_short.csv')
# %%
...
dems_dict['sex_chi'] = chi2_contingency(contingency_table1) # p = 0.8918
contingency_table4 = pd.crosstab(matched_short['group'], matched_short['race'])
dems_dict['ethnicity_chi'] = chi2_contingency(contingency_table4) # p = 0.0096
dems_dict['age'] = stats.ttest_ind(matched_HR['interview_age'], matched_LR['interview_age']) # p = 0.3972
print(dems_dict)
# %%
count_instances_race(matched_HR)
# 39.36% white, 30.58% black, 24.05% hispanic, 6.01% other
# %%
count_instances_race(matched_LR)
#39.53% white, 26.42% black, 28.32% hispanic, 5.72% other
# %%
...
#save df to file
pps_hr_lr.to_csv('/Users/madeleineseitz/Desktop/T2_pps_hr_lr_all_fu.csv')
#isolate df containing HR and LR at follow-up 2 only
pps_hr_lr_4 = pps_hr_lr.loc[pps_hr_lr['visit'] == 4]
#save T2 df to file
pps_hr_lr_4.to_csv('/Users/madeleineseitz/Desktop/pps_hr_lr_t2.csv')
# %%
...
matched_demos.to_csv('/Users/madeleineseitz/Desktop/T2_matched_demos.csv')
# %%
