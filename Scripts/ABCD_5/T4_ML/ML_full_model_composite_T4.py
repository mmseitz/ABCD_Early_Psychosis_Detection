...
CHAPTER_ID = 'sklearn_uniform_all_features_ABCD5_T4_test_clean'
...
def save_png(fig_id, tight_layout=True, fig_extension='png', resolution=300):
    ...
    plt.savefig(path, format=fig_extension, dpi=resolution)
# Set directory
os.chdir("/Users/madeleineseitz/Desktop/sklearn_uniform_all_features_ABCD5_T4_test_clean")
# %%
# Import data....
def data():
    print("Loading data...", end="")
    X_train = pd.read_csv('/Users/madeleineseitz/Desktop/ABCD_5/T2_abcd5_all_features/X_train_uniform_all_features_reduced_abcd5_T2.csv')
    X_train = X_train.drop(columns= ['Unnamed: 0'])
    X_train = X_train.to_numpy()
    y_train = pd.read_csv("/Users/madeleineseitz/Desktop/ABCD_5/T2_abcd5_all_features/y_train_all_data_abcd5_T2.csv")
    y_train = y_train['group'].to_numpy()
    X_test = pd.read_csv('/Users/madeleineseitz/Desktop/ABCD_5/T4_abcd5_all_features/X_test_uniform_all_features_reduced_abcd5_T4.csv')
    X_test = X_test.drop(columns= ['Unnamed: 0'])
    X_test = X_test.to_numpy()
    y_test = pd.read_csv("/Users/madeleineseitz/Desktop/ABCD_5/T4_abcd5_all_features/y_test_all_data_abcd5_T4.csv")
...
# %%
names = pd.read_csv('/Users/madeleineseitz/Desktop/ABCD_5/T2_abcd5_all_features/X_train_uniform_all_features_reduced_abcd5_T2.csv')
...
feature_grid = {'feature_eng': [None,
                              ...
                              SelectColumns(['tfmri_ma_rpvnfb_b_cds_clcgelh', 'tfmri_ma_acgml_b_scs_tplh', 'tfmri_sst_beh_performflag', 'tfmri_sst_all_beh_crgo_nt',
 ...
 'nihtbx_picture_agecorrected', 'disc_3_b', 'lmt_scr_avg_rt', 'lmt_scr_rt_correct', 'speech_4', 'disc_2_b'])]} #SFFS/SFBS
