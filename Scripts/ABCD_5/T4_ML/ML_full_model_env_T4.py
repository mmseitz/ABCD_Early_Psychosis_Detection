#Full model (environmental features only)
# %%
...
CHAPTER_ID = 'sklearn_uniform_env_only_ABCD5_T4_test_clean'
...
def save_png(fig_id, tight_layout=True, fig_extension='png', resolution=300):
    ...
    plt.savefig(path, format=fig_extension, dpi=resolution)
# Set directory
os.chdir("/Users/madeleineseitz/Desktop/sklearn_uniform_env_only_ABCD5_T4_test_clean")
# %%
# Import data....
def data():
    print("Loading data...", end="")
    X_train = pd.read_csv('/Users/madeleineseitz/Desktop/ABCD_5/T2_abcd5_env/X_train_uniform_env_reduced_abcd5_T2.csv')
    X_train = X_train.drop(columns= ['Unnamed: 0'])
    X_train = X_train.to_numpy()
    y_train = pd.read_csv("/Users/madeleineseitz/Desktop/ABCD_5/T2_abcd5_env/y_train_env_data_abcd5_T2.csv")
    y_train = y_train['group'].to_numpy()
    X_test = pd.read_csv('/Users/madeleineseitz/Desktop/ABCD_5/T4_abcd5_env/X_test_uniform_env_reduced_abcd5_T4_clean.csv')
    X_test = X_test.drop(columns= ['Unnamed: 0'])
    X_test = X_test.to_numpy()
    y_test = pd.read_csv("/Users/madeleineseitz/Desktop/ABCD_5/T4_abcd5_env/y_test_env_data_abcd5_T4_clean.csv")
...
# %%
names = pd.read_csv('/Users/madeleineseitz/Desktop/ABCD_5/T4_abcd5_env/X_test_uniform_env_reduced_abcd5_T4_clean.csv')
...
def plot_learning_curve(estimator, title,  X, y, cv=None,
    ...
    plt.ylim(-1, -0.2)
    plt.hlines(-logloss_threshold, 50, 800, colors='violet', label='chance level', linestyles='dashed', linewidth=1)
    plt.hlines(-base_logloss, 50, 800, colors='orange', label='base logloss', linestyles='dashed', linewidth=1)
    plt.legend(loc="best")
    plt.title(title)
...
feature_grid = {'feature_eng': [None,
                              ...
                              SelectColumns(['weeks_preterm', 'age_roll_over', 'age_walk', 'total_times_to_ER', 'ple_p_ss_affected_good_sum', 
...
'ple_p_ss_total_number', 'ple_p_ss_total_good', 'ple_p_ss_total_bad', 'ple_y_ss_total_bad',
 ...
 'preterm_1', 'disc_1_a', 'disc_1_b', 'crime_4', 'crime_5', 'times_to_ER_past_year',
   ...
   'motor_4', 'disc_4_a', 'disc_4_b'])]} # SFFS_SBFS_RFE
...
plt.ylabel('Feature')
plt.title('Feature Importances for Linear Discriminant Analysis Model')
...
plt.xlabel('Mean Importance')
plt.ylabel('Feature')
plt.title('Feature Importances for Quadratic Discriminant Analysis Model')
...
plt.xlabel('Mean Importance')
plt.ylabel('Feature')
plt.title('Feature Importances for Gaussian Naive Bayes Model')
