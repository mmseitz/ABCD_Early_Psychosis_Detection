...
abcd = pd.read_csv('/Users/madeleineseitz/Desktop/ABCD_5/uniform_csvs/T2/abcd5_T2_uniform_abcd_nonan.csv')
...
#### Import raw data
print('Importing raw data...', end="")
abcd = pd.read_csv('/Users/madeleineseitz/Desktop/ABCD_5/uniform_csvs/T4/abcd5_T4_uniform_abcd_nonan.csv')
#drop 2 sst cols because data is constant
abcd = abcd.drop (columns= ['Unnamed: 0', 'tfmri_sst_all_beh_total_nt', 'tfmri_sst_nbeh_nruns'])
# %%
...
abcd['group'].sum()
X_test = abcd
X_test = X_test.drop(columns= ['doubled'])
y_test = abcd['group']
#abcd shape (139, 46)
# abcd T4 HR = 80
# %%
X_test.to_csv('/Users/madeleineseitz/Desktop/all_data_x_test.csv')
# %%
...
# %%
# np.save("/Users/madeleineseitz/Desktop/X_train_all_data_abcd5_T4.npy", X_train)
# np.save("/Users/madeleineseitz/Desktop/y_train_all_data_abcd5_T4.npy", y_train)
# X_train = pd.DataFrame(X_train)
#X_train.columns = cols
# X_train.to_csv('/Users/madeleineseitz/Desktop/X_train_all_data_abcd5_T4.csv', index=None, header=True)
# y_train.to_csv('/Users/madeleineseitz/Desktop/y_train_all_data_abcd5_T4.csv', index=None, header=True)
#y_test = pd.Series(X_test.group)
y_test =  X_test[['group']]
y_test.to_csv('/Users/madeleineseitz/Desktop/y_test_all_data_abcd5_T4.csv', index=None, header=True)
y_test = y_test.to_numpy()
#X_test = prepared_data[0].drop(['group'], axis=1)
np.save("/Users/madeleineseitz/Desktop/X_test_all_data_abcd5_T4.npy", X_test)
np.save("/Users/madeleineseitz/Desktop/y_test_all_data_abcd5_T4.npy", y_test)
X_test = pd.DataFrame(X_test)
#X_test.columns = cols
X_test.to_csv('/Users/madeleineseitz/Desktop/X_test_all_data_abcd5_T4.csv', index=None, header=True)
# %%
no_doubles = ['tfmri_ma_rpvnfb_b_cds_clcgelh', 'tfmri_ma_acgml_b_scs_tplh', 'tfmri_sst_beh_performflag', 'tfmri_sst_all_beh_crgo_nt',
...
# %%
X_test_reduced.to_csv('/Users/madeleineseitz/Desktop/X_test_uniform_all_features_reduced_abcd5_T4.csv')
#X_train_reduced.to_csv('/Users/madeleineseitz/Desktop/X_train_uniform_all_features_reduced_abcd5_T4.csv')
# %%
