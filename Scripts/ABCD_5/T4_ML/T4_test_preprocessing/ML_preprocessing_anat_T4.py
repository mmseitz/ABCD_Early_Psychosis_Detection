...
#### Import T4 raw data
print('Importing raw data...', end="")
abcd = pd.read_csv('/Users/madeleineseitz/Desktop/ABCD_5/uniform_csvs/T4/abcd5_uniform_T4_anat_abcd_nonan.csv')
abcd = abcd.drop(columns= ['Unnamed: 0'])
# %%
...
# %%
# np.save("/Users/madeleineseitz/Desktop/X_train_anat_data_abcd5_T4.npy", X_train)
# np.save("/Users/madeleineseitz/Desktop/y_train_anat_data_abcd5_T4.npy", y_train)
# X_train = pd.DataFrame(X_train)
#X_train.columns = cols
# X_train.to_csv('/Users/madeleineseitz/Desktop/X_train_anat_data_abcd5_T4.csv', index=None, header=True)
# y_train.to_csv('/Users/madeleineseitz/Desktop/y_train_anat_data_abcd5_T4.csv', index=None, header=True)
#y_test = pd.Series(X_test.group)
y_test =  X_test[['group']]
y_test.to_csv('/Users/madeleineseitz/Desktop/y_test_anat_data_abcd5_T4_clean.csv', index=None, header=True)
y_test = y_test.to_numpy()
np.save("/Users/madeleineseitz/Desktop/y_test_anat_data_abcd5_T4_clean.npy", y_test)
X_test = prepared_data[0].drop(['group'], axis=1)
np.save("/Users/madeleineseitz/Desktop/X_test_anat_data_abcd5_T4_clean.npy", X_test)
X_test = pd.DataFrame(X_test)
#X_test.columns = cols
X_test.to_csv('/Users/madeleineseitz/Desktop/X_test_anat_data_abcd5_T4_clean.csv', index=None, header=True)
# %%
...
# %%
X_test_reduced.to_csv('/Users/madeleineseitz/Desktop/X_test_uniform_anat_reduced_abcd5_T4.csv')
#X_train_reduced.to_csv('/Users/madeleineseitz/Desktop/X_train_uniform_anat_reduced_abcd5_T4.csv')
# %%
