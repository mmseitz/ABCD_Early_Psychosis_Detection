...
#### Import raw data
print('Importing raw data...', end="")
abcd = pd.read_csv('/Users/madeleineseitz/Desktop/ABCD_5/uniform_csvs/T4/cog_T4_abcd5.csv')
...
# Predictive Features
cort_cols = list(abcd)[3:-6]
#dropnans
X_test = X_test.dropna() #shape (1370, 504) HR n = 658
# %%
# """ DEFINE AND APPLY TRAIN/TEST SPLIT """
# print('Define train/test split...', end="")
# class TrainTestSplit(BaseEstimator, TransformerMixin):
...
postreg_pipeline = Pipeline([
    ...
    ('addlabels', AddInLabels( y_test=y_test)),
    ('dropna', DropNaN()),
...
# %%
# np.save("/Users/madeleineseitz/Desktop/X_train_cog_only_data_abcd5_T4.npy", X_train)
# np.save("/Users/madeleineseitz/Desktop/y_train_cog_data_abcd5_T4.npy", y_train)
# X_train = pd.DataFrame(X_train)
#X_train.columns = cols
# X_train.to_csv('/Users/madeleineseitz/Desktop/X_train_cog_only_data_abcd5_T4.csv', index=None, header=True)
# y_train.to_csv('/Users/madeleineseitz/Desktop/y_train_cog_only_data_abcd5_T4.csv', index=None, header=True)
#y_test = pd.Series(X_test.group)
y_test =  X_test[['group']]
y_test.to_csv('/Users/madeleineseitz/Desktop/y_test_cog_only_data_abcd5_T4_clean.csv', index=None, header=True)
y_test = y_test.to_numpy()
X_test = prepared_data[0].drop(['group'], axis=1)
np.save("/Users/madeleineseitz/Desktop/X_test_cog_only_data_abcd5_T4_clean.npy", X_test)
np.save("/Users/madeleineseitz/Desktop/y_test_cog_only_data_abcd5_T4_clean.npy", y_test)
X_test = pd.DataFrame(X_test)
#X_test.columns = cols
X_test.to_csv('/Users/madeleineseitz/Desktop/X_test_cog_only_data_abcd5_T4_clean.csv', index=None, header=True)
# %%
no_doubles = ['tfmri_ma_aclvn_b_scs_aylh', 'tfmri_ma_acmvn_b_scs_aylh', 'tfmri_ma_rpvnfb_b_cds_clmdfrlh', 'tfmri_ma_rpvnfb_b_cds_romdfrrh', 
 ...
 'tfmri_ma_acgml_b_scs_aylh', 'tfmri_ma_lvnfb_b_cds_clatcgelh', 'tfmri_ma_lvnfb_b_cds_roagelh',
 ...
 'tfmri_sst_all_beh_crgo_rt', 'tfmri_sst_all_beh_crlg_nt', 'tfmri_sst_all_beh_incrgo_rt', 'tfmri_sst_all_beh_incrgo_stdrt',
...
# %%
X_test_reduced.to_csv('/Users/madeleineseitz/Desktop/X_test_uniform_cog_reduced_abcd5_T4_clean.csv')
#X_train_reduced.to_csv('/Users/madeleineseitz/Desktop/X_train_uniform_cog_reduced_abcd5_T4.csv')
# %%
