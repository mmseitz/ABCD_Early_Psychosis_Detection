...
CHAPTER_ID = 'sklearn_uniform_cog_only_ABCD5_T4_test_clean'
...
def save_png(fig_id, tight_layout=True, fig_extension='png', resolution=300):
    ...
    plt.savefig(path, format=fig_extension, dpi=resolution)
# Set directory
os.chdir("/Users/madeleineseitz/Desktop/sklearn_uniform_cog_only_ABCD5_T4_test_clean")
# %%
# Import data....
def data():
    print("Loading data...", end="")
    X_train = pd.read_csv('/Users/madeleineseitz/Desktop/ABCD_5/T2_abcd5_cog_only/X_train_uniform_cog_reduced_abcd5_T2.csv')
    X_train = X_train.drop(columns= ['Unnamed: 0', 'tfmri_sst_nbeh_nruns', 'tfmri_ma_rpvnfb_b_cds_clcgelh'])
    ...
    X_test = pd.read_csv('/Users/madeleineseitz/Desktop/ABCD_5/T4_abcd5_cog_only/X_test_uniform_cog_reduced_abcd5_T4_clean.csv')
    X_test = X_test.drop(columns= ['Unnamed: 0'])
    X_test = X_test.to_numpy()
    y_test = pd.read_csv("/Users/madeleineseitz/Desktop/ABCD_5/T4_abcd5_cog_only/y_test_cog_only_data_abcd5_T4_clean.csv")
...
# %%
names = pd.read_csv('/Users/madeleineseitz/Desktop/ABCD_5/T4_abcd5_cog_only/X_test_uniform_cog_reduced_abcd5_T4_clean.csv')
