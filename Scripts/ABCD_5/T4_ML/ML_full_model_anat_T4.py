#Full model (anatomical features only)
# %%
...
CHAPTER_ID = 'sklearn_uniform_anat_only_ABCD5_T4_test_clean'
...
def save_png(fig_id, tight_layout=True, fig_extension='png', resolution=300):
    ...
    plt.savefig(path, format=fig_extension, dpi=resolution)
# Set directory
os.chdir("/Users/madeleineseitz/Desktop/sklearn_uniform_anat_only_ABCD5_T4_test_clean")
# %%
# Import data....
def data():
    print("Loading data...", end="")
    X_train = pd.read_csv('/Users/madeleineseitz/Desktop/ABCD_5/T2_abcd5_anat_only/X_train_uniform_anat_reduced_abcd5_T2.csv')
    X_train = X_train.drop(columns= ['Unnamed: 0'])
    X_train = X_train.to_numpy()
    y_train = pd.read_csv("/Users/madeleineseitz/Desktop/ABCD_5/T2_abcd5_anat_only/y_train_anat_data_abcd5_T2.csv")
    y_train = y_train['group'].to_numpy()
    X_test = pd.read_csv('/Users/madeleineseitz/Desktop/ABCD_5/T4_abcd5_anat_only/X_test_uniform_anat_reduced_abcd5_T4.csv')
    X_test = X_test.drop(columns= ['Unnamed: 0'])
    X_test = X_test.to_numpy()
    y_test = pd.read_csv("/Users/madeleineseitz/Desktop/ABCD_5/T4_abcd5_anat_only/y_test_anat_data_abcd5_T4_clean.csv")
...
# %%
names = pd.read_csv('/Users/madeleineseitz/Desktop/ABCD_5/T4_abcd5_anat_only/X_test_uniform_anat_reduced_abcd5_T4.csv')
...
feature_grid = {'feature_eng': [None,
                              ...
                              SelectColumns(['smri_thick_cdk_cdacatelh', 'smri_thick_cdk_cuneuslh', 'smri_thick_cdk_ihcatelh', 'smri_thick_cdk_paracnlh',
...
'smri_vol_cdk_sufrlh', 'smri_vol_cdk_banksstsrh', 'smri_vol_cdk_total', 'smri_thick_cdk_cdmdfrlh', 'smri_thick_cdk_ifpllh',
 ...
 'smri_thick_cdk_smrh', 'smri_thick_cdk_insularh', 'smri_vol_cdk_smlh', 'smri_vol_cdk_parahpalrh', 'smri_vol_cdk_insularh'])]} #SFFS/SFBS
