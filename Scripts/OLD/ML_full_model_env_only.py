...
CHAPTER_ID = 'sklearn_uniform_env_only_ABCD'
...
def save_png(fig_id, tight_layout=True, fig_extension='png', resolution=300):
    ...
    plt.savefig(path, format=fig_extension, dpi=resolution)
# Set directory
os.chdir("/Users/madeleineseitz/Desktop/sklearn_uniform_env_only_ABCD")
# %%
# Import data....
def data():
    print("Loading data...", end="")
    X_train = pd.read_csv('/Users/madeleineseitz/Desktop/thesis/ABCD_Project/csvs/ML/Env_Only_Uniform_Model/X_train_uniform_env_reduced.csv')
    #X_train = X_train.drop(columns= ['Unnamed: 0'])
    X_train = X_train.to_numpy()
    y_train = pd.read_csv("/Users/madeleineseitz/Desktop/thesis/ABCD_Project/csvs/ML/Env_Only_Uniform_Model/y_train_env_data.csv")
    y_train = y_train['group'].to_numpy()
    X_test = pd.read_csv('/Users/madeleineseitz/Desktop/thesis/ABCD_Project/csvs/ML/Env_Only_Uniform_Model/X_test_uniform_env_reduced.csv')
    #X_test = X_test.drop(columns= ['Unnamed: 0'])
    X_test = X_test.to_numpy()
    y_test = pd.read_csv("/Users/madeleineseitz/Desktop/thesis/ABCD_Project/csvs/ML/Env_Only_Uniform_Model/y_test_env_data.csv")
...
# %%
names = pd.read_csv('/Users/madeleineseitz/Desktop/thesis/ABCD_Project/csvs/ML/Env_Only_Uniform_Model/X_train_uniform_env_reduced.csv')
...
feature_grid = {'feature_eng': [None,
                              ...
                              SelectColumns(['ple_y_ss_affected_bad_sum', 'peq_ss_relational_aggs', 'peq_ss_overt_victim', 'total_substances_used', 
'weeks_preterm', 'injury_totals', 'p_edu_1', 'income_3', 'motor_1', 'motor_3', 'motor_4', 'motor_5',
 'speech_3', 'speech_4', 'speech_5', 'p_edu_3', 'income_2', 'speech_1', 'speech_2', 'income_1',
   'ple_y_ss_total_bad', 'motor_2'])]} # SFFS_SBFS_RFE
