...
# Example data
#set.seed(123)
groupHR <- read_csv('/Users/madeleineseitz/Desktop/thesis/ABCD_Project/csvs/PQ-BC/pps_T2_HR_demos.csv')

groupLR <- read_csv('/Users/madeleineseitz/Desktop/thesis/ABCD_Project/csvs/PQ-BC/pps_T2_LR_demos.csv')
...
write.csv(matched_data, "/Users/madeleineseitz/Desktop/thesis/ABCD_Project/csvs/PQ-BC/R_MatchIt/demos_matched.csv")
write.csv(matched_groupLR, "/Users/madeleineseitz/Desktop/thesis/ABCD_Project/csvs/PQ-BC/R_MatchIt/LR_matched.csv")